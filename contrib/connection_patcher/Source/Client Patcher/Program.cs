    ...
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length == 1)
            {
                ...
                {
                    Console.WriteLine("CMaNGOS Cata Patcher");
                    ...
                    switch (patcher.Type)
                    {
                        case BinaryTypes.Pe32:
                            patcher.Patch(Patches.Windows.x86.A1, Patterns.Windows.x86.A1);
                            patcher.Patch(Patches.Windows.x86.A2, Patterns.Windows.x86.A2);
                            patcher.Patch(Patches.Windows.x86.A3, Patterns.Windows.x86.A3);
                        ...
                        case BinaryTypes.Pe64:
                            patcher.Patch(Patches.Windows.x64.B1, Patterns.Windows.x64.B1);
                            patcher.Patch(Patches.Windows.x64.B2, Patterns.Windows.x64.B2);
