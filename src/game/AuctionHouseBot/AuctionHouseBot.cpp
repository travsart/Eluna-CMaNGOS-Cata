...
class AuctionBotSeller : public AuctionBotAgent
{
    ...
    private:
        ...
        void        SetPricesOfItem(AHB_Seller_Config& config, uint64& buyp, uint64& bidp, ItemQualities itemQuality);
...
{
    if (!m_AhBotCfg.SetSource(m_configFileName.c_str(), "Mangosd_"))
    {
...
void AuctionBotSeller::SetPricesOfItem(AHB_Seller_Config& config, uint64& buyp, uint64& bidp, ItemQualities itemQuality)
{
