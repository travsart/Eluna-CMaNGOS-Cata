...
enum SpellTarget
{
    ...
    TARGET_LOCATION_UNIT_POSITION_63                   = 63,
    ...
    TARGET_UNK_111                                     = 111,               // not used
    TARGET_LOCATION_UNIT_POSITION_112                  = 112,               // spell 89549
    TARGET_UNK_113                                     = 113,               // not used
    TARGET_UNK_114                                     = 114,               // not used
    TARGET_UNK_115                                     = 115,               // not used
    TARGET_UNK_116                                     = 116,               // not used
    TARGET_UNK_117                                     = 117,               // test spell 83658
    TARGET_UNIT_TARGET_ALLY_OR_RAID                    = 118,               // test spell 79579
    TARGET_CORPSE_SRC_AREA_RAID                        = 119,               // mass ressurection 83968
    TARGET_UNIT_CASTER_AND_SUMMONS                     = 120,
    TARGET_CORPSE_TARGET_ALLY                          = 121,               // spell 95750
    TARGET_UNIT_AREA_THREAT_LIST                       = 122,               // spell 100661
    TARGET_UNIT_AREA_TAP_LIST                          = 123,
    TARGET_UNIT_TARGET_TAP_LIST                        = 124,
    TARGET_PLAYER_RAID_NYI_125                         = 125,
